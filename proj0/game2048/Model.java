...
public class Model extends Observable {
    ...
    public boolean tilt(Side side) {
        ...
        int size = board.size();
        boolean[][] mergedThisRound = new boolean[size][size];
        for (int c = 0; c < size; c++) {
            for (int r = size - 2; r >= 0; r--) {
                ...
                while (targetRow + 1 < size) {
                    Tile above = board.tile(c, targetRow + 1);
                    if (above == null) {
                        targetRow++;
                    } else if (above.value() == t.value() && !mergedThisRound[c][targetRow + 1]) {
                        targetRow++;
                        break;
                    } else {
                        break;
                ...
                if (targetRow != r) {
                    ...
                    if(merged){
                        ...
                        mergedThisRound[c][targetRow] = true;
                    }
                }
            }
        }
